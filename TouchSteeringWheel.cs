...
namespace RGSK
{
    [RequireComponent(typeof(MobileTouchButton))]
    public class TouchSteeringWheel : MonoBehaviour
    {
        private MobileTouchButton mobileTouchButton;
        ...
        public float maximumSteeringAngle = 90;
        public float wheelReleasedSpeed = 200f;

        void Start()
        {
            mobileTouchButton = GetComponent<MobileTouchButton>();
        ...
        void Update()
        {
            ...
            //update mobiletouchbutton input
            mobileTouchButton.InputValue = GetClampedValue();
        }
